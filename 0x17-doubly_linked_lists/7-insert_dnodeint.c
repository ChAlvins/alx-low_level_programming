...
/**
 * insert_dnodeint_at_index - inserting a newnode at a given position
 * @h: ptr to the head of the dlistint_t list
 * @idx: the index of the list where the newnode should be added
 * Index starts at 0
 * @n: integer that newnode shd to contain
